...
#### Download latest bulletin audio for a station

`GET /stations/{id}/bulletins/latest/audio`
...
**Response:** `200` - Latest bulletin audio file



**Error Responses:**

- `404`: Station not found or no bulletin available for this station


---

#### Get latest bulletin for a station

`GET /stations/{id}/bulletins/latest`

Returns the most recently generated bulletin for a specific station. This endpoint is ideal for radio automation systems that need to fetch the latest news bulletin.
...
**Response:** `200` - Latest bulletin found



**Error Responses:**

- `404`: Station not found or no bulletin available
