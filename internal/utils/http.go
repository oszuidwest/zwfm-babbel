...
type UserCreateRequest struct {
	...
	Metadata *string `json:"metadata,omitempty" binding:"omitempty,json"`
}
...
type StoryCreateRequest struct {
	...
	Metadata  *string         `json:"metadata,omitempty" form:"metadata" binding:"omitempty,json"`
}
...
// BindFormAndValidate binds and validates JSON or form data requests.
